...
gem 'gitlab-secret_detection', '>= 0.19.1', '< 1.0', feature_category: :secret_detection
...
gem 'ruby-saml', '~> 1.18.0', feature_category: :system_access
...
gem 'ohai', '~> 18.2', '>= 18.2.6', feature_category: :product_analytics
...
gem 'semver_dialects', '~> 3.7', '>= 3.7.0', feature_category: :software_composition_analysis
...
gem 'async', '~> 2.23.1', require: false, feature_category: :shared
...
group :development do
  ...
  gem 'rubocop', '>= 1.71.2', feature_category: :tooling
  gem 'solargraph', '~> 0.48.0', require: false, feature_category: :shared
...
group :development, :test do
  ...
  gem 'haml_lint', '~> 0.61', '>= 0.61.0', feature_category: :tooling
...
group :development, :test, :omnibus do
  gem 'license_finder', '~> 7.2', '>= 7.2.0', require: false, feature_category: :shared
end
...
gem 'gitaly', '~> 17.8.4', feature_category: :gitaly

# KAS GRPC protocol definitions
gem 'gitlab-kas-grpc', '~> 17.9.2.0.0', feature_category: :deployment_management
